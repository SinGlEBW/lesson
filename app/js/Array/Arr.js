...
*/
 ...
 /*
    map - тот же самый цикл forEatch, только с возможностью возвращать результат.
 */
...
let o = [
 ...
 console.dir({...o, ...a});//Заменит 0 индекс
 console.dir({...[1,4,7].push(44)});//push вернёт length а не массив
...
// Принцип.
// Ну раз мы ищем значит с 0 индекса и начнём. Возьмём его число и будем надеяться что оно всех меньше,
// если нет возьмём его индекс и продолжим сравнить с ним остальные числа. Нужно перебирать массив, возьмём forEach.
// Можно создать счётчик, тем самым мы можем узнать сколько же было достойных сравнений.  
 ...
 4 < 4 // - false count 0
 4 < 2 //  - false count 0
 4 < 6 //  - true count 1, переход ко 2му элементу, а нам нужно к элементу под inx этой итерации
 2 < 1 //  - false count 1
 2 < 7 //  - true count 2
 2 < 8 //  - true count 3
 2 < 1 //  - false count 3
//И того 3
 ...
 //Так что нужно изначально понимать что счётчик это последовательное движение чисел.
 let itemInx = 0;//так правильно называть 
 a.forEach((item, inx) => {
   if(a[itemInx] < item){
     itemInx = inx;
 }})
 ...
 4 < 4 // - false itemInx 0
 4 < 2 //  - false itemInx 0
 4 < 6 //  - true itemInx 2, присвоили inx числа 6
 6 < 1 //  - false itemInx 2
 6 < 7 //  - true itemInx 4
 7 < 8 //  - true itemInx 5
 8 < 1 //  - false itemInx 5
 //И того inx 5 то есть 8 наибольшее значение
