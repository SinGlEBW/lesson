...
//доступность (видимость) переменных и функций вида Function Declaration
/*
	Function Declaration. Каждая такая функция:
	1. Может вызываться как перед её определением так и после
	2. Каждый вызов создаёт новую локальную область.
	3. Область видимости Scope следит в какой локальной области что было вызвано
	4. Создать ивент в одной локальной области и удалить в другой не получиться
*/
