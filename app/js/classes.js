...
/* 
Надо проверить
Приватные поля в классе обявляються с # перед его именем. Из вне получить доступ к такому имени напрямую через 
экземпляр не получится.*/
class User{
  constructor(name) {
    this.#name = name;
  }
...
/*
но через метод можно, не смотря на то что у имени #. Но опять же если метод с # то тоже не достучаться.
Закономерность доступа при обращении через #.
*/