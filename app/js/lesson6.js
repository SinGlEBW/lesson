...
/*
  Немного об использовании данных в функциях. Callback'ами можно передавать данные, использовать их внутри, 
  но есть ещё одна фишка которая даёт возможность использовать данные одной локальной области,
  в другой локальной области. Можно передать через callback, а можно использовать глобальную переменную.
  В глобальной области изменений мы не увидим, но если что-то присвоить этой переменной в одной функции
  и потом проверить эту переменную в другой функции, то мы обнаружим что она не пуста.
  Конечно тут внимательно нужно следить за порядком изменения этой переменной. Если мы будем искать значения
  до их присвоения, то их там и не будет
