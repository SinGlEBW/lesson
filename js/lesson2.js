...
//ЗАДАНИЕ 1. Создать и добавить элемент 
	var parent = document.getElementById('wrap');//выбраный родитель
	var span1 = document.createElement("span"); //создынй элемент
...
// insertBefore принимает аргументы дочерних элементов. 
	...
	var h2 = document.createElement("h2");//ещё создынй элемент
	parent.appendChild(h2);//добавляет в конец списка к дочерним элементам
//	console.log(parent.childNodes);

//ЗАДАНИЕ 2. Добавить текст в созданый елемент 
